...
namespace Maken.Infrastructure.Migrations
{
    ...
    [Migration("20260211234531_AddContactInquiryIndexes")]
    partial class AddContactInquiryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maken.Domain.Entities.ContactInquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsDeleted", "Status", "SubmittedAt")
            ...
            modelBuilder.Entity("Maken.Domain.Entities.ContactInquiry", b =>
                {
                    b.HasOne("Maken.Domain.Entities.User", null)
                        .WithMany()
